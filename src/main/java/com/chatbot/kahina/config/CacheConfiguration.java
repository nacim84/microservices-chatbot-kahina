...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("microservicesChatbotKahina");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("microservicesChatbotKahina");
        ...
        config.getMapConfigs().put("com.chatbot.kahina.domain.*", initializeDomainMapConfig(jHipsterProperties));
